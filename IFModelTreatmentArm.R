#### Incidental Findings Model (treatment arm) #####
## To begin: Go to http://www.cdc.gov/nchs/products/life_tables.htm and download life tables for men, women, and the total U.S. population.
## Save these life tables in the same directory as CSV files
#datasources.directory <- "C:/Users/DavisWeaver/Documents/R/DataSources" 
TreatmentLifeExpectancy <- function(directory, sex, comorbidity, start.age = 66){   ###Initialize function###
  if(start.age < 66) {
